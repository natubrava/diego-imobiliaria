...
- carregamento conjunto e cache curto para trocar de tela sem repetir consultas à planilha;
- recuperação automática de falhas transitórias sem repetir operações de gravação;
