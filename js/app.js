import { renderDashboard } from './dashboard.js?v=20260812-6';
import { renderLocacoes, openLocacaoModal } from './imoveis.js?v=20260812-6';
import { renderFinanceiro } from './pagamentos.js?v=20260812-6';
import { renderVendas, openVendaModal } from './vendas.js?v=20260812-6';
import { renderConfiguracoes } from './configuracoes.js?v=20260812-6';
import { clearCache, consumePrivateAccessLink } from './api.js?v=20260812-6';
import { closeModal, escHtml, openModal, renderIcons, toast } from './utils.js?v=20260812-6';
